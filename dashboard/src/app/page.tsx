"use client";
// ← FIXED: Root Cause 1: Replaced page.tsx content directly with real-time websocket page content
import { useEffect, useState, useCallback, useRef } from "react"; // ← NEW: added useCallback, useRef
